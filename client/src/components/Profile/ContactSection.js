...
const ContactSection = () => (
    <section className="section container " id='contact'>
        ...
        <Row className="center">
            ...
            <Col l={4} s={4}><li><a target="_blank" rel="noopener noreferrer" href="https://discord.gg/DR3YNu" className="btn-floating btn-small black "><i className="fab fa-trello fa-2x white-text"></i></a><b>Discord</b></li></Col>
            </ul>
        </Row>
    </section>
);
